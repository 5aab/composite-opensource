...
public interface VehicleRepository extends JpaRepository<Vehicle, Integer> {
    ...
    @Query("select new com.example.spring.boot.composite.domain.composite.CompositeOutputVO(v.id,v.type,v.modelCode,v.brandName,v.launchDate,i.insuredBy,i.insuredOn) from Vehicle v, Insurance i where v.id=i.id and v.brandName= :brandName")
